...
<ul class="sidebar-menu">
	...
	<li class="treeview"><a href="role/list" class="ajaxlink">
	<i class="fa fa-fw fa-bank"></i> Role </a></li>

<li class="treeview"><a href="profil/create" class="ajaxlink">
	<i class="fa fa-fw fa-bank"></i> Profil </a></li>

	<li class="treeview"><a href="personnelAdministratif/list" class="ajaxlink">
	<i class="fa fa-fw fa-bank"></i> Personnel Administratif </a></li>
	
	<li class="treeview"><a href="privilege/list" class="ajaxlink">
	<i class="fa fa-fw fa-bank"></i> Privelege </a></li>
