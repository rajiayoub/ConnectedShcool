...
<ui:row>
	...
	<ui:panel title="Privileges" columnWidth="8">
		<ui:actions>
			<ui:action label="Privilege" href="privilege/create"
		...
		<ui:body>
			<ui:list>
				<c:forEach items="${privileges}" var="privilege">
					...
					<span class="text"><c:out value="${privilege.libellePrivilege}"></c:out></span>
