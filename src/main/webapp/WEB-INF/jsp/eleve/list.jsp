...
<ui:row>
	...
	<ui:panel title="ETABLISSEMENTS" columnWidth="8">
		<ui:actions>
			<ui:action label="Nouvel eleve" href="eleve/create"
				icon="fa-plus"></ui:action>
		</ui:actions>
		<ui:body>
			<ui:list>
				<c:forEach items="${etablissements}" var="eleve">
					<li class=""><span class="handle"> <i
						class="fa fa-angle-double-right"></i> </span> <!-- checkbox --> <!-- todo text -->
					<span class="text"><c:out value="${eleve.codeNationalEtudiant}"></c:out></span>
