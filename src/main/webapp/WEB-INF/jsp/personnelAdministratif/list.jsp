...
<ui:row>
	...
	<ui:panel title="PersonnelAdministratif" columnWidth="8">
		<ui:actions>
			<ui:action label="PersonnelAdministratif" href="personnelAdministratif/create"
				icon="fa-plus"></ui:action>
		</ui:actions>
		<ui:body>
			<ui:list>
				<c:forEach items="${personnelAdministratifs}" var="personnelAdministratif">
					<li class=""><span class="handle"> <i
						class="fa fa-angle-double-right"></i> </span> <!-- checkbox --> <!-- todo text -->
					<span class="text"><c:out value="${personnelAdministratif.service}"></c:out></span>
