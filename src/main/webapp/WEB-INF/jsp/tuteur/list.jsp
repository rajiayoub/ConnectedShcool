...
<ui:row>
	...
	<ui:panel title="TUTEURS" columnWidth="8">
		<ui:actions>
			<ui:action label="Nouvelle tuteur" href="tuteur/create"
				icon="fa-plus"></ui:action>
		</ui:actions>
		<ui:body>
			<ui:list>
				<c:forEach items="${tuteurs}" var="tuteur">
					<li class=""><span class="handle"> <i
						class="fa fa-angle-double-right"></i> </span> <!-- checkbox --> <!-- todo text -->
					<span class="text"><c:out value="${tuteur.cin}"></c:out></span>
