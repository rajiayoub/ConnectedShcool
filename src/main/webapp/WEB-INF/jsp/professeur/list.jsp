...
<ui:row>
	...
	<ui:panel title="PROFESSEURS" columnWidth="8">
		<ui:actions>
			<ui:action label="Nouveeau Professeur" href="professeur/create"
		...
		<ui:body>
			<ui:list>
				<c:forEach items="${professeurs}" var="professeur">
					...
					<span class="text"><c:out value="${professeur.matricule}"></c:out></span>
