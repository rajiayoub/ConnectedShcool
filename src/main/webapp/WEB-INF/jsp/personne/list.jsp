...
<ui:row>
	...
	<ui:panel title="ROLE" columnWidth="8">
		<ui:actions>
			<ui:action label="Nouveau role" href="role/create"
				icon="fa-plus"></ui:action>
		</ui:actions>
		<ui:body>
			<ui:list>
				<c:forEach items="${role}" var="etablissement">
					<li class=""><span class="handle"> <i
						class="fa fa-angle-double-right"></i> </span> <!-- checkbox --> <!-- todo text -->
					<span class="text"><c:out value="${role.matricule}"></c:out></span>
